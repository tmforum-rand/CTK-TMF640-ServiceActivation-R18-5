...
console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF640 Service Activation and Configuration\n");
getURL();
...
function runNewman(){
    ...
    newman.run({
        collection: require('./CTK-TMF640-ServiceActivationAndConfiguration-R18-5.postman_collection.json'),
